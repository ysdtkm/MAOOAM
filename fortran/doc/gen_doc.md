...
Full details over the parameterization options and definition files are available [here](md_sto_doc.html).
...
This stochastic version is further detailed [here](md_sto_doc.html).
...
terms \f$R,G,\sigma,M_1,M_2,M_3\f$. They are detailed more completely [here](md_sto_doc.html).
