...
\begin{DoxyCode}
91     \textcolor{keywordtype}{INTEGER} :: allocstat
92 
93     namelist /aoscale/  scale,f0,n,rra,phi0\_npi
...
102 
103     namelist /int\_params/ t\_trans,t\_run,dt,tw,writeout
104 
105     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"params.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
106 
107     \textcolor{keyword}{READ}(8,nml=aoscale)
108     \textcolor{keyword}{READ}(8,nml=oparams)
109     \textcolor{keyword}{READ}(8,nml=aparams)
110     \textcolor{keyword}{READ}(8,nml=toparams)
111     \textcolor{keyword}{READ}(8,nml=taparams)
112     \textcolor{keyword}{READ}(8,nml=otparams)
113 
114     \textcolor{keyword}{CLOSE}(8)
115 
116     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"modeselection.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
117     \textcolor{keyword}{READ}(8,nml=numblocs)
118 
119     \textcolor{keyword}{ALLOCATE}(oms(nboc,2),ams(nbatm,2), \hyperlink{namespacestat}{stat}=allocstat)
120     \textcolor{keywordflow}{IF} (allocstat /= 0) stop \textcolor{stringliteral}{"*** Not enough memory ! ***"}
121 
122     \textcolor{keyword}{READ}(8,nml=modeselection)
123     \textcolor{keyword}{CLOSE}(8)
124 
125     \textcolor{comment}{! Must still sort modeselection here}
126 
127     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"int\_params.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
128     \textcolor{keyword}{READ}(8,nml=int\_params)
129 
130 
\end{DoxyCode}
